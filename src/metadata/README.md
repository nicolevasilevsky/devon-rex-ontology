 ...
 * [devo.yml](devo.yml)
     * Determines how your purl.obolibrary.org/obo/devo/ redirects will be handled
     ...
     * Paste in the contents of [devo.yml](devo.yml)
 ...
 * [devo.md](devo.md)
     ...
     * Paste in the contents of [devo.md](devo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
